...
{
	public static void renderConveyorWorld(RenderBlocks renderblocks, IBlockAccess iblockaccess, int blockX, int blockY, int blockZ, Block block, int renderId)
	{
		...
		float brightness = block.getBlockBrightness(iblockaccess, blockX, blockY, blockZ);
